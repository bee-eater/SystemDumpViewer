...
#define MY_APP_VERSION 2,4,5,29003
#define MY_APP_VERSION_STRING "2.4.5.29003"
...
namespace Version
{
	...
	static const int REVISION = 5;	/**< Bugfix version number */
	static const int BUILD = 29003;	/**< Number depending on day of build */
}
