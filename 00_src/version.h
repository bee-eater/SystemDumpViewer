...
#define MY_APP_VERSION 2,1,11,23030
#define MY_APP_VERSION_STRING "2.1.11.23030"
...
namespace Version
{
    ...
    static const int REVISION = 11;	/**< Git revision */
	static const int BUILD = 23030;	/**< Number depending on day of build */
}
