...
#define MY_APP_VERSION 2,4,3,28159
#define MY_APP_VERSION_STRING "2.4.3.28159"
...
namespace Version
{
	...
	static const int REVISION = 3;	/**< Bugfix version number */
	static const int BUILD = 28159;	/**< Number depending on day of build */
}
