...
#define MY_APP_VERSION 2,2,15,24278
#define MY_APP_VERSION_STRING "2.2.15.24278"
...
namespace Version
{
    ...
    static const int REVISION = 15;	/**< Git revision */
    static const int BUILD = 24278;	/**< Number depending on day of build */
}
