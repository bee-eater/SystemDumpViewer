...
#define MY_APP_VERSION 2,4,4,28200
#define MY_APP_VERSION_STRING "2.4.4.28200"
...
namespace Version
{
	...
	static const int REVISION = 4;	/**< Bugfix version number */
	static const int BUILD = 28200;	/**< Number depending on day of build */
}
